...
func addRoutes(m *http.ServeMux, repo Repository, logger *slog.Logger) {
	...
	m.Handle("GET /plotter/scatter", makePlotterHandler("scatter", repo, logger))
	m.Handle("GET /plotter/heatmap", makePlotterHandler("heatmap", repo, logger))
