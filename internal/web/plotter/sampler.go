...
func (s *Sampler) getTimestamp(measurement repository.Measurement) float64 {
...
func (s *Sampler) getRange(measurements []repository.Measurement, axis string) *Range {
	var minMax Range
...
func (s *Sampler) process(measurements []repository.Measurement) {
