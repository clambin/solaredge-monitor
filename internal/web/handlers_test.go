...
func TestPlotterHandler(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			measurements: repository.Measurements{
				{Timestamp: time.Date(2024, time.December, 23, 12, 0, 0, 0, time.UTC), Power: 1000, Intensity: 65, Weather: "SUN"},
				{Timestamp: time.Date(2024, time.December, 23, 12, 15, 0, 0, time.UTC), Power: 1000, Intensity: 65, Weather: "SUN"},
				{Timestamp: time.Date(2024, time.December, 23, 12, 30, 0, 0, time.UTC), Power: 1000, Intensity: 65, Weather: "SUN"},
				{Timestamp: time.Date(2024, time.December, 23, 12, 45, 0, 0, time.UTC), Power: 1000, Intensity: 65, Weather: "SUN"},
				{Timestamp: time.Date(2024, time.December, 23, 13, 0, 0, 0, time.UTC), Power: 1000, Intensity: 65, Weather: "SUN"},
			},
			wantCode: http.StatusOK,
		},
		{
